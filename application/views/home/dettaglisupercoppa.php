                                                    ...
                                                    <tbody>
                                                        ...
                                                        for ($c = 0; $c < count($player); $c++) {
                                                            ...
                                                            if ($row['id1'] == $player[$c]['id_utente']) {
                                                                ...
                                                                @$media_difensori = $this->mdl_team->getDettagliCampionatoTotaleModificatoreCoppa($row['id1'], $giornata, 1, "supercoppa");
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for ($c = 0; $c < count($player); $c++) {
                                                            if ($row['id2'] == $player[$c]['id_utente']) {
                                                                ...
                                                                //Calcolo media voto difensori per Modificatore difesa
                                                                @$media_difensori = $this->mdl_team->getDettagliCampionatoTotaleModificatoreCoppa($row['id2'], $giornata, 2, "supercoppa");
