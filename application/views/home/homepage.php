                                  ...
                                  <td class="team-leader__player">
                                    <div class="team-leader__player-info">
                                      ...
                                      <div class="team-leader__player-inner">
                                        <h5 class="team-leader__player-name"><?= $row['cognome'] . " " . $row['nome'] ?></h5>
                      ...
                      <tr bgcolor="#fafafa"> 
                        <td class="team-leader__player">
                          <div class="team-leader__player-info">
                            ...
                            <div class="team-leader__player-inner">
                              <h5 class="team-leader__player-name"><?= $row['cognome'] . " " . substr($row['nome'],0,1) . "." ?></h5>
                              <span class="team-leader__player-position">Portiere</span>
                            </div>
                          </div>
                        </td>
                      ...
                      <tr bgcolor="#f0fbff">
                        <td class="team-leader__player">
                          <div class="team-leader__player-info">
                            ...
                            <div class="team-leader__player-inner">
                              <h5 class="team-leader__player-name"><?= $row['cognome'] . " " . substr($row['nome'],0,1) . "." ?></h5>
                              <span class="team-leader__player-position">Difensore</span>
                            </div>
                          </div>
                        </td>
                        <td class="team-leader__goals"><?= $row['voto'] ?></td>
                      ...
                      <tr bgcolor="#fff2f2">
                        <td class="team-leader__player">
                          <div class="team-leader__player-info">
                            ...
                            <div class="team-leader__player-inner">
                              <h5 class="team-leader__player-name"><?= $row['cognome'] . " " . substr($row['nome'],0,1) . "." ?></h5>
                              <span class="team-leader__player-position">Centrocampista</span>
                            </div>
                          </div>
                        </td>
                        <td class="team-leader__goals"><?= $row['voto'] ?></td>
                      ...
                      <tr bgcolor="#eefaeb">
                        <td class="team-leader__player">
                          <div class="team-leader__player-info">
                            ...
                            <div class="team-leader__player-inner">
                              <h5 class="team-leader__player-name"><?= $row['cognome'] . " " . substr($row['nome'],0,1) . "." ?></h5>
                              <span class="team-leader__player-position">Attaccante</span>
                            </div>
                          </div>
                        </td>
                        <td class="team-leader__goals"><?= $row['voto'] ?></td>
                    ...
                    <div class="widget-game-result__main">
                      ...
                      <div class="widget-game-result__team widget-game-result__team--first">
                        <figure class="widget-game-result__team-logo">
                          <a href="#"><img src="<?= base_url('/') ?>assets/images/soccer/logos/alchemists_last_game_results_big.png" alt=""></a>
                        </figure>
                      ...
                      <div class="widget-game-result__team widget-game-result__team--second">
                        <figure class="widget-game-result__team-logo">
                          <a href="#"><img src="<?= base_url('/') ?>assets/images/samples/logo-l-clovers--sm.png" alt=""></a>
                        </figure>
                        <div class="widget-game-result__team-info">
                    ...
                    <div class="df-timeline">
                      ...
                      <div class="df-timeline__event df-timeline__event--start">
                        <div class="df-timeline__team-1">
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-shirt.svg" alt="" class="df-timeline__team-shirt">
                        </div>
                        <div class="df-timeline__time">0’</div>
                        <div class="df-timeline__team-2">
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-shirt-alt.svg" alt="" class="df-timeline__team-shirt">
                        </div>
                      </div>
                      ...
                      <div class="df-timeline__event">
                        <div class="df-timeline__team-1">
                          ...
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-soccer-ball.svg" width="16" height="16" alt="" class="df-timeline__event-icon">
                        </div>
                      ...
                      <div class="df-timeline__event">
                        ...
                        <div class="df-timeline__team-2">
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-yellow-card.svg" alt="" class="df-timeline__event-icon">
                          <div class="df-timeline__event-info">
                      ...
                      <div class="df-timeline__event">
                        ...
                        <div class="df-timeline__team-2">
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-substitution.svg" alt="" class="df-timeline__event-icon">
                          <div class="df-timeline__event-info">
                      ...
                      <div class="df-timeline__event">
                        <div class="df-timeline__team-1">
                          ...
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-red-card.svg" alt="" class="df-timeline__event-icon">
                        </div>
                      ...
                      <div class="df-timeline__event">
                        <div class="df-timeline__team-1">
                          ...
                          <img src="<?= base_url('/') ?>assets/images/soccer/icon-soccer-ball-penalty.svg" alt="" class="df-timeline__event-icon">
                        </div>
