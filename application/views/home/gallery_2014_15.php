        ...
        <div class="site-content">
            ...
            <div class="container">
                <div class="content-title">
                    <h2 class="content-title__h">Stagione 2014/15</h2>
                ...
                <div class="row">
                    <div class="album__item col-xs-6 col-sm-4">
                        <div class="album__item-holder">
                            <a href="<?= base_url('/') ?>assets/images/gallery/copertina_2014_15.jpg" class="album__item-link mp_gallery">
                    ...
                    <div class="album__item col-xs-6 col-sm-4">
                        <div class="album__item-holder">
                            <a href="<?= base_url('/') ?>assets/images/gallery/2014_15_1.jpg" class="album__item-link mp_gallery">
                                <figure class="album__thumb">
                                    <img src="<?= base_url('/') ?>assets/images/gallery/2014_15_1.jpg" alt="">
                                </figure>
                                <div class="album__item-desc">
                    ...
                    <div class="album__item col-xs-6 col-sm-4">
                        <div class="album__item-holder">
                            <a href="<?= base_url('/') ?>assets/images/gallery/2014_15_2.jpg" class="album__item-link mp_gallery">
                                <figure class="album__thumb">
                                    <img src="<?= base_url('/') ?>assets/images/gallery/2014_15_2.jpg" alt="">
                                </figure>
                                <div class="album__item-desc">
                    ...
                    <div class="album__item col-xs-6 col-sm-4">
                        <div class="album__item-holder">
                            <a href="<?= base_url('/') ?>assets/images/gallery/2014_15_3.jpg" class="album__item-link mp_gallery">
                                <figure class="album__thumb">
                                    <img src="<?= base_url('/') ?>assets/images/gallery/2014_15_3.jpg" alt="">
                                </figure>
                                <div class="album__item-desc">
