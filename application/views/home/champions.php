            ...
            <div class="container">
                ...
                <div class="card card--has-table">
                    <div class="card__header">
                        <!-- Anno da modificare -->
                        <h4>Classifica Girone A 2018/19</h4>
                    </div>
                                    ...
                                    foreach ($classifica_championsA as $row) {
                                        ...
                                        <tr <?= $color ?> >
                                            ...
                                            <td class="team-standings__team">
                                                <div class="team-meta">
                                                    ...
                                                    <div class="team-meta__info">
                                                        <h6 class="team-meta__name" style="color: #1892ED; font-size: 12px;"><a href="<?= base_url('/') ?>utente/team/<?= $row['id_squadra'] ?>"><?= $this->mdl_utenti->getSquadra($row['id_squadra']) ?></a>
                                                            <?php
                                            ...
                                            <td class="team-standings__points-diff">
                                                ...
                                                <?php
                                                $forma = $this->mdl_team->getFormaSquadraChampions($row['id_squadra'], $giornata);
                ...
                <div class="card card--has-table">
                    <div class="card__header">
                        <!-- Anno da modificare -->
                        <h4>Classifica Girone B 2018/19</h4>
                    </div>
                    <div class="card__content">
                        <div class="table-responsive">
                            <table class="table table-hover table-standings table-standings--full table-standings--full-soccer">
