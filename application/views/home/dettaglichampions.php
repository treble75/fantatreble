        ...
        if ($giornata <= 27) {
            ...
            $labelChampions = "Giornata " . $giornata;
        }

        if ($giornata == 23 || $giornata == 24) {

            $labelChampions = "Quarti";
        }
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <ol class="page-heading__breadcrumb breadcrumb">
                            <li class="active"><?= $labelChampions ?></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        foreach ($risultati_champions as $row) {
            ...
            for ($c = 0; $c < count($player); $c++) {
                ...
                if ($row['id1'] == $player[$c]['id_utente']) {
                    ...
                    @$media_difensori = $this->mdl_team->getDettagliCampionatoTotaleModificatoreCoppa($row['id1'], $giornata, 1, "champions");
            ...
            for ($c = 0; $c < count($player); $c++) {
                if ($row['id2'] == $player[$c]['id_utente']) {
                    ...
                    //Calcolo media voto difensori per Modificatore difesa
                    @$media_difensori = $this->mdl_team->getDettagliCampionatoTotaleModificatoreCoppa($row['id2'], $giornata, 2, "champions");
