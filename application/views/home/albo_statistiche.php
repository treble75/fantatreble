        ...
        <!-- Page Heading
        ================================================== -->
        <div class="page-heading page-heading-albo-statistiche">
            <div class="container">
                <div class="row">
        ...
        <nav class="content-filter">
            <div class="container">
                ...
                <ul class="content-filter__list">
                    <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>home/albo_statistiche" class="content-filter__link"><small>Albo d'oro</small>Statistiche</a></li>
                        ...
                        <div role="tabpanel" class="tab-pane fade in active" id="tab-precedenti">
                            ...
                            <section class="product-tabs__section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="control-label" for="review-title">Elenco storico squadre partecipanti al fantatreble</label>
                                        <div class="form-group">
                                            <ol class="list">
                                                <?php
                ...
                if ($check == 1) {
                    ...
                    <div class="card card--clean">
                        ...
                        <div class="card__content">
                            ...
                            <?php
                            if (is_array(@$supercoppa2018_19) && count(@$supercoppa2018_19) > 0) {
                                $parzialeSC += count(@$supercoppa2018_19);
                                ?>
                                <!-- PARTITE DEI PRECEDENTI STORICI 2018-19 -->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover team-result">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                foreach ($supercoppa2018_19 as $row) {
                                                    ?>
                                                    ...
                                                    <tr>
                                                            ...
                                                            <div class="team-meta">
                                                                <figure class="team-meta__logoCalendar">
                                                                    <?php if ($row['id1'] != $row['id2']) { ?>
                                                                        <img src="<?= base_url('/') ?>images/storico/logo/<?= $this->mdl_utenti->getLogoStorico($row['id1'], "2018-19") ?>">
                                                                    <?php } ?>
                                                                </figure>
                                                                <div class="team-meta__info">
                                                                    <h6 class="team-meta__name"><?= $this->mdl_utenti->getSquadraPrecedente($row['id1'], "2018-19") ?></h6>
                                                                    <span class="team-meta__place"><?= $this->mdl_utenti->getNomeUtentePrecedente($row['id1'], "2018-19") ?></span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <?php
                                                        if ($radio == "squadra") {
                                                            if ($squadra1 == $this->mdl_utenti->getSquadraPrecedente($row['id1'], "2018-19")) {
                                                            ...
                                                            if ($squadra1 == $this->mdl_utenti->getSquadraPrecedente($row['id2'], "2018-19")) {
                                                            ...
                                                            if ($squadra2 == $this->mdl_utenti->getSquadraPrecedente($row['id1'], "2018-19")) {
                                                                if ($row['risultato1'] > $row['risultato2']) {
                                                                    $parzVSC2 += 1;
                                                                }
                                                                if ($row['risultato1'] == $row['risultato2']) {
                                                            ...
                                                            if ($squadra2 == $this->mdl_utenti->getSquadraPrecedente($row['id2'], "2018-19")) {
                                                                if ($row['risultato2'] > $row['risultato1']) {
                                                                    $parzVSC2 += 1;
                                                                }
                                                                if ($row['risultato2'] == $row['risultato1']) {
                                                        ...
                                                        if ($radio == "utente") {
                                                            if ($squadra1 == $this->mdl_utenti->getNomeUtentePrecedente($row['id1'], "2018-19")) {
                                                                if ($row['risultato1'] > $row['risultato2']) {
                                                                    $parzVSC1 += 1;
                                                                }
                                                                if ($row['risultato1'] == $row['risultato2']) {
                                                            ...
                                                            if ($squadra1 == $this->mdl_utenti->getNomeUtentePrecedente($row['id2'], "2018-19")) {
                                                                if ($row['risultato2'] > $row['risultato1']) {
                                                                    $parzVSC1 += 1;
                                                                }
                                                                if ($row['risultato2'] == $row['risultato1']) {
                                                            ...
                                                            if ($squadra2 == $this->mdl_utenti->getNomeUtentePrecedente($row['id1'], "2018-19")) {
                                                                if ($row['risultato1'] > $row['risultato2']) {
                                                                    $parzVSC2 += 1;
                                                                }
                                                                if ($row['risultato1'] == $row['risultato2']) {
                                                            ...
                                                            if ($squadra2 == $this->mdl_utenti->getNomeUtentePrecedente($row['id2'], "2018-19")) {
                                                                if ($row['risultato2'] > $row['risultato1']) {
                                                                    $parzVSC2 += 1;
                                                                }
                                                                if ($row['risultato2'] == $row['risultato1']) {
                                                        ...
                                                        <td class="team-result__status" align='right' style="width: 22%">
                                                            <div class="team-meta" style="text-align: right;">
                                                                <div class="team-meta__info" align='right'>
                                                                    <h6 class="team-meta__name"><?= $this->mdl_utenti->getSquadraPrecedente($row['id2'], "2018-19") ?></h6>
                                                                    <span class="team-meta__place"><?= $this->mdl_utenti->getNomeUtentePrecedente($row['id2'], "2018-19") ?></span>
                                                                </div>
                                                                <figure class="team-meta__logoCalendar">
                                                                    <?php if ($row['id1'] != $row['id2']) { ?>
                                                                        <img src="<?= base_url('/') ?>images/storico/logo/<?= $this->mdl_utenti->getLogoStorico($row['id2'], "2018-19") ?>">
                                                                    <?php } ?>
                                                                </figure>
                                                            </div>
                                                        </td>
                                ...
                                <!-- PARTITE DEI PRECEDENTI STORICI 2018-19  / End -->

                                <?php
                            }

                            if (is_array(@$coppa2018_19) && count(@$coppa2018_19) > 0) {
                                $parzialeCO += count(@$coppa2018_19);
                                ?>
                                <!-- PARTITE DEI PRECEDENTI STORICI 2018-19 -->
                                <div class="card card--has-table">
                            ...
                            if (is_array(@$champions2018_19) && count(@$champions2018_19) > 0) {
                                $parzialeCH += count(@$champions2018_19);
                                ?>
                                <!-- PARTITE DEI PRECEDENTI STORICI 2018-19 -->
                                <div class="card card--has-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover team-result">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                foreach ($champions2018_19 as $row) {
                                                    ?>
                            ...
                            if (is_array(@$precedenti2018_19) && count(@$precedenti2018_19) > 0) {
                                $parzialeTL += count(@$precedenti2018_19);
                                ?>
                                <!-- PARTITE DEI PRECEDENTI STORICI 2018-19 -->
                                <div class="card card--has-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover team-result">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                foreach (@$precedenti2018_19 as $row) {
                                                    ?>
