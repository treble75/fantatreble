				...
				<nav class="content-filter">
				  <div class="container">
				    ...
				    <ul class="content-filter__list">
				      ...
				      <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>index.php/home/marcatori" class="content-filter__link"><small>Treble League</small>Marcatori</a></li>
								...
								<tbody>
                                                                    ...
                                                                    ?>
                                                                            ...
                                                                            <tr style="padding: 0px 0px;" <?= $bgcolor ?> >
                                                                                    ...
                                                                                    <td class="team-roster-table__name" style="vertical-align: middle; width: 14%;"><?= $this->mdl_team->getNomeTeam($row['id_utente']) ?></td>
                                                                            </tr>
                                                                    <?php
                                                                        } 
                                                                    $i++;
