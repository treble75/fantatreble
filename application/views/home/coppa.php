        ...
        <!-- Page Heading
        ================================================== -->
        <div class="page-heading page-heading-coppa">
            <div class="container">
                <div class="row">
        ...
        <nav class="content-filter">
            <div class="container">
                ...
                <ul class="content-filter__list">
                    ...
                    <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>index.php/home/coppa" class="content-filter__link"><small>Coppa Treble</small>Griglia</a></li>
            ...
            <div class="container">
                ...
                <div class="card card--has-table">
                    <div class="card__header">
                        <!-- Anno da modificare -->
                        <h4>Coppa Treble 2018/19</h4>
                    </div>
                    <div class="card__content">
                        <div class="table-responsive">

                            <figure>
                                <img src="<?= base_url('/') ?>images/sfondo_coppa.jpg" >
                            </figure>
