        ...
        <!-- Page Heading
        ================================================== -->
        <div class="page-heading page-heading-marcatori_precedenti">
            <div class="container">
                <div class="row">
        ...
        <nav class="content-filter">
            <div class="container">
                ...
                <ul class="content-filter__list">
                    <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>home/marcatori_precedenti/<?= $stagione ?>" class="content-filter__link"><small>Treble League</small>Marcatori</a></li>
                    ...
                    <li class="content-filter__item "><a href="<?= base_url('/') ?>home/calendari_precedenti/<?= $stagione ?>" class="content-filter__link"><small>Treble League</small>Risultati</a></li>
                </ul>
            </div>
        </nav>
