                                    ...
                                    <div class="widget__content card__content">
                                        <ul class="team-stats-box">
                                            <li class="team-stats__item team-stats__item--clean">
                                                ...
                                                $media = ( $this->mdl_team->getMediaGolFatti($utente[0]['id_utente']) / $this->mdl_team->getPartiteGiocateTL($utente[0]['id_utente']));
                                                ?>
                                            ...
                                            <li class="team-stats__item team-stats__item--clean">
                                                ...
                                                <?php
                                                //Calcolo maggior mediagolsubiti
                                                $media = ( $this->mdl_team->getMediaGolSubiti($utente[0]['id_utente']) / $this->mdl_team->getPartiteGiocateTL($utente[0]['id_utente']));
                                                ?>
                                                <div class="team-stats__value"><?= number_format($media, 2) ?></div>
                                            ...
                                            <li class="team-stats__item team-stats__item--clean">
                                                ...
                                                //Calcolo maggior mediagolsubiti
                                                if ($giornata_media > 0) {
                                                    $media = ( $this->mdl_team->getMediaAssistFatti($utente[0]['id_utente']) / $this->mdl_team->getPartiteGiocateTL($utente[0]['id_utente']));
                                                }
                                                ?>
                                                <div class="team-stats__value"><?= number_format(@$media, 2) ?></div>
                                            ...
                                            <li class="team-stats__item team-stats__item--clean">
                                                ...
                                                <?php
                                                $partite_giocate = $this->mdl_team->getPartiteGiocateTL($utente[0]['id_utente']);
                                                $totale_cartellini = $this->mdl_team->getTotaleCartellini($utente[0]['id_utente']);
                                                if ($giornata_media > 0) {
