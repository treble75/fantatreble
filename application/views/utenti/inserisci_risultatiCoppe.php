            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        ?>
                        <h1 class="page-heading__title">Risultati di <span class="highlight">Coppa</span></h1>
                        <span class="highlight" style="color: #c2ff1f; font-size: 18px;"><?= $competizione ?></span>
                        ...
                        <div class="table-responsive" style="min-width:768px;">
                            ...
                            if (count($risultati) < 1) { ?>
                                ...
                                <div class = 'alert alert-warning alert-dismissible'>
                                    <strong>Non viene disputata nessuna partita di coppa in questa giornata</strong>
                                </div>
                            <?php
                            }
                            
                            echo form_open_multipart('utente/inserisci_risultati_Coppe');
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for ($c = 0; $c < count($titolari); $c++) {
                                                            if ($row['id1'] == $titolari[$c]['id_utente']) {
                                                                ...
                                                                @$num_difensori = $this->mdl_team->getNumeroDifensoriCoppa($row['id1']);

                                                                //Calcolo media voto difensori per Modificatore difesa
                                                                @$media_difensori = $this->mdl_team->getMediaDifensoriCoppa($row['id1'], $giornata);
                                                        ...
                                                        for ($c = 0; $c < count($panchinari); $c++) {
                                                            ...
                                                            if ($row['id1'] == $panchinari[$c]['id_utente']) {
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P1'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P1']);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P2'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P2']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P3'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P3']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P4'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P4']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P5'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P5']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P6'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P6']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P7'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P7']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P8'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P8']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P9'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P9']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P10'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P10']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P11'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P11']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P12'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P12']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P13'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P13']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                                ...
                                                                <tr <?= $colRuolo ?> >
                                                                    ...
                                                                    <td class="lineup__name" style="font-size: 11px;"><?= $dettagli[0]['cognome'] . " " . $dettagli[0]['nome'] ?></td>
                                                                    <?php
                                                                    $v = $this->mdl_team->getVotoCoppa($panchinari[$c]['P14'], $giornata);
                                                                    $v = (is_Array($v) ? "S.V." : $v);
                                                                    $voto = $this->mdl_team->getFantavotoPCoppa($panchinari[$c]['P14']);
                                                                    $voto = (is_Array($voto) ? "" : $voto);
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for ($c = 0; $c < count($titolari); $c++) {
                                                            if ($row['id2'] == $titolari[$c]['id_utente']) {
                                                                ...
                                                                //Calcolo numeri difensori per Modificatore difesa
                                                                @$num_difensori = $this->mdl_team->getNumeroDifensoriCoppa($row['id2']);

                                                                //Calcolo media voto difensori per Modificatore difesa
                                                                @$media_difensori = $this->mdl_team->getMediaDifensoriCoppa($row['id2'], $giornata);
                            ...
                            if ($competizione != "") { ?>
                                ...
                                <div class="form-group--submit">
                                    <input type="submit" value="Inserisci Risultati di Coppa" name="but_risultati" class="btn btn-default btn-lg btn-block">
                                </div>
