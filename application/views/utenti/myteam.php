        ...
        <div class="card">
            ...
            <div class="card__content">
                <div class="glossary">
                    ...
                    <div class="glossary__item"><span class="glossary__abbr"><img src="<?= base_url('/') ?>images/ammo.png"> :</span> Numero di Ammonizioni al FantaTreble</div>
                    <div class="glossary__item"><span class="glossary__abbr"><img src="<?= base_url('/') ?>images/espu.png"> :</span> Numero di Espulsioni al FantaTreble</div>
                    <div class="glossary__item"><span class="glossary__abbr">GO :</span> Gol Realizzati al FantaTreble</div>
                    <div class="glossary__item"><span class="glossary__abbr">AS :</span> Assist Realizzati al FantaTreble</div>
                    <div class="glossary__item"><span class="glossary__abbr">VO :</span> Media Voto al FantaTreble</div>
                    <div class="glossary__item"><span class="glossary__abbr">FV :</span> Media FantaVoto al FantaTreble</div>
                </div>
            </div>
        </div>
        <!-- Player Glossary / End -->
