        ...
        <!-- Page Heading
        ================================================== -->
        <div class="page-heading page-heading-myteam-risultati">
            <div class="container">
                <div class="row">
        ...
        <nav class="content-filter">
            <div class="container">
                ...
                <ul class="content-filter__list">
                    ...
                    <li class="content-filter__item "><a href="<?= base_url('/') ?>utente/myteam_statistiche" class="content-filter__link"><small>My Team</small>Statistiche</a></li>
                    <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>utente/myteam_risultati" class="content-filter__link"><small>My Team</small>Risultati</a></li>
            ...
            <div class="container">
                ...
                <div class="product-tabs card card--xlg">
                    ...
                    <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#tab-supercoppa" role="tab" data-toggle="tab"><small>Risultati</small>SuperCoppa Treble</a></li>
                    </ul>
                    ...
                    <div class="tab-content card__content">
                        ...
                        <!-- Tab: Coppa Treble / End -->
                        
                        <!-- Tab: SuperCoppa Treble -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover team-result">
                                        ...
                                        <tbody>
                                            ...
                                            $bgcolor = 'bgcolor="#ffffff"';
                                            $i = 1;
                                            foreach ($partitegiocateSuperCoppa as $row) {
                                                if ($row['id1'] == $_SESSION['id_utente'] || $row['id2'] == $_SESSION['id_utente']) {
                                                    $colore = "";
                                                    $label = "";
                                                    $evidenzia1 = "";
