            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <h1 class="page-heading__title">Bacheca <span class="highlight"><?= $utente[0]['squadra'] ?></span></h1>
        ...
        <nav class="content-filter">
            <div class="container">
                ...
                <ul class="content-filter__list">
                    ...
                    <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>utente/team_bacheca/<?= $utente[0]['id_utente'] ?>" class="content-filter__link"><small>Team</small>Bacheca</a></li>
                </ul>
            </div>
        </nav>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="alc-staff__photo">
                                                    <img src="<?= base_url('/') ?>images/<?= $utente[0]['id_utente'] ?>.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="alc-staff-inner">
                                                    <header class="alc-staff__header">
                                                        ...
                                                        if ($utente[0]['squadra'] == "Real B.B.") {
                                                            $squadra = "Real Blues Brothers";
                                                        } else {
                                                            $squadra = $utente[0]['squadra'];
                                                        }
                                                        ?>
