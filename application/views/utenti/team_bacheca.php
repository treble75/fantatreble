        ...
        <nav class="content-filter">
            <div class="container">
                ...
                <ul class="content-filter__list">
                    ...
                    <li class="content-filter__item content-filter__item--active"><a href="<?= base_url('/') ?>index.php/utente/team_bacheca/<?= $utente[0]['id_utente'] ?>" class="content-filter__link"><small>Team</small>Bacheca</a></li>
                </ul>
            </div>
        </nav>
