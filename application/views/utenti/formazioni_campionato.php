        ...
        if ($giornata == 36) {
            ...
            $label = "Stagione Terminata";
        }
        ?>

        <div class="page-heading page-heading-formazioni-campionato">
            <div class="container">
                <div class="row">
                            ...
                            <?php if ($giornata == 36) { ?>
                                ...
                                <div align="center" style="width:100%" style="text-align: center;">
                                    <div class="alert alert-info">
                                        Non viene disputata nessuna partita di Treble League in questa giornata
                                    </div>
                                </div>
                                <?php
                            }
