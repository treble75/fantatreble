...
class Utente extends CI_Controller {
    ...
    public function elenco_rigoristi() {
        if (isset($_SESSION['id_utente'])) {
            ...
            $data['active'] = 3;
            $this->show('utenti/elenco_rigoristi.php', $data);
        } else
            redirect('utente/login');
    }
...
//                    return;
    ...
    public function team_statistiche($team) {
        if (isset($_SESSION['id_utente'])) {
            $this->load->model('mdl_utenti');
            $this->load->model('mdl_team');
            $_SESSION['giornata'] = $this->mdl_team->getGiornata();
    ...
    public function team_calendario($team) {
        if (isset($_SESSION['id_utente'])) {
            ...
            $data['prossimiMatchSuperCoppa'] = $this->mdl_team->getProssimiMatchSuperCoppa($team);
